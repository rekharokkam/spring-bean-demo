CREATE TABLE IF NOT EXISTS `practice`.`RENTAL_LOCATION` (
...
CREATE TABLE IF NOT EXISTS `practice`.`MEDIA` (
  ...
  CONSTRAINT `RENTAL_LOCATION_FK`
    ...
    REFERENCES `practice`.`RENTAL_LOCATION` (`RENTAL_LOCATION_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

CREATE TABLE IF NOT EXISTS `practice`.`RENTAL` (
  ...
  CONSTRAINT `MEDIA_FK`
    ...
    REFERENCES `practice`.`MEDIA` (`MEDIA_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);